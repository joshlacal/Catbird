...
//                    )
    ...
    static func fetchTaggedSuggestions(client: ATProtoClient) async throws -> [TaggedSuggestion] {
        ...
        do {
            ...
            var suggestionsByTag: [String: [String]] = [:]
            
            for suggestion in suggestions {
                let tag = suggestion.tag
                let subjectDid = extractDidFromURI(suggestion.subject.uriString())
    ...
    private static func fetchProfilesForDIDs(client: ATProtoClient, dids: [String]) async throws -> [AppBskyActorDefs.ProfileViewDetailed] {
    ...
    private static func extractDidFromURI(_ uriString: String) -> String {
