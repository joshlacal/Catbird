...
final class MLSAPIClientTests: XCTestCase {
    ...
    func testGetConversationsSuccess() async throws {
        ...
        let expectedURL = testBaseURL.appendingPathComponent("/xrpc/blue.catbird.chat.getConversations")
    ...
    func testGetConversationsWithPagination() {
        ...
        var components = URLComponents(url: testBaseURL.appendingPathComponent("/xrpc/blue.catbird.chat.getConversations"), resolvingAgainstBaseURL: true)!
    ...
    func testCreateConversationURL() {
        let url = testBaseURL.appendingPathComponent("/xrpc/blue.catbird.chat.createConversation")
        XCTAssertEqual(url.path, "/xrpc/blue.catbird.chat.createConversation")
    }
    ...
    func testGetMessagesURLConstruction() {
        ...
        var components = URLComponents(url: testBaseURL.appendingPathComponent("/xrpc/blue.catbird.chat.getEntries"), resolvingAgainstBaseURL: true)!
        components.queryItems = [
    ...
    func testGetKeyPackagesURLConstruction() {
        ...
        var components = URLComponents(url: testBaseURL.appendingPathComponent("/xrpc/blue.catbird.chat.getDevices"), resolvingAgainstBaseURL: true)!
