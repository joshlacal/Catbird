...
/// Main interface for browsing parsed repository data
struct RepositoryBrowserView: View {
    ...
    private func triggerBackupParsing(_ backup: BackupData) async {
        ...
        do {
            ...
            guard let parsingService = appState.repositoryParsingService else { return }
            ...
            let repositoryRecord = try await parsingService.startRepositoryParsing(for: backupRecord)
    ...
    private var emptyStateView: some View {
        VStack(spacing: 20) {
            ...
            Text("No repository data found. Create backup CAR files from your account in Settings, or parse existing backup files to explore your data.")
