...
struct OnboardingContent {
  ...
  static let welcome = OnboardingStep(
    ...
    description: "Your beautiful Bluesky client. Catbird makes it easy to connect with friends, discover new voices, and join conversations that matter to you.",
  ...
  static let feedDiscovery = OnboardingStep(
    ...
    description: "Bluesky's custom feeds let you see exactly what you want. Tap the + button to explore feeds curated by the community, or create your own.",
