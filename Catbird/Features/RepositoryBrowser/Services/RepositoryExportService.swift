...
// MARK: - Repository Export Service

/// Service for exporting repository data in various formats
/// This exports parsing results with privacy safeguards
@MainActor
final class RepositoryExportService {

    // MARK: - Properties

    private let logger = Logger(subsystem: "blue.catbird", category: "RepositoryExport")
    ...
    private func createCSVFile(_ exportData: RepositoryExportData, at url: URL) async throws {
        ...
        // Add header
        csvContent += "# Catbird Repository Export\n"
    ...
    private func createHTMLFile(_ exportData: RepositoryExportData, at url: URL) async throws {
        ...
        <body>
            <div class="header">
                <div class="warning">DATA EXPORT</div>
                <p>This export contains parsing results from Catbird's Repository Browser.
            ...
            <footer style="margin-top: 50px; padding-top: 20px; border-top: 1px solid #ddd; color: #666; font-size: 0.9em;">
                Generated by Catbird Repository Browser - \(Date())
            </footer>
        </body>
        </html>
        """
