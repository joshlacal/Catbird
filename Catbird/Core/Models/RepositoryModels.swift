...
// MARK: - Repository Parsing Models

/// Represents a parsed repository from a CAR backup
@Model
...
/// Represents a parsed AT Protocol record using Petrel data structures.
/// Stores the actual AT Protocol records as ATProtocolValueContainer instances.
@Model
final class ParsedATProtocolRecord: @unchecked Sendable {
    ...
    /// Contains the ATProtocolValueContainer with the parsed record.
    var recordData: Data
...
final class ParsedPost: @unchecked Sendable {
    ...
    /// Safe display text with full sanitization
...
/// Represents a parsed profile from the repository
@Model
...
/// Represents parsed media references from the repository
@Model
...
/// Represents parsed social connections (follows/followers)
@Model
...
/// Represents unknown/unparsed records for debugging
@Model
