...
private class MemoryMonitor {
    private let warningThreshold: UInt64 = 600_000_000 // 600MB warning
    private let criticalThreshold: UInt64 = 1_000_000_000 // 1GB critical (iOS kills ~1.4GB)
...
///
/// The `ParsedRecord` type is still used by `ATProtoRepoParser` for output compatibility.
