...
@available(iOS 18.0, *)
struct UnblockProfileIntent: AppIntent {
    static let title: LocalizedStringResource = "Unblock Profile"
    static let description = IntentDescription("Unblock a Bluesky account.")
